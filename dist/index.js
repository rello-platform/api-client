...
var ALL_PERMISSION_SLUGS = Object.values(
  PERMISSIONS
).map((p) => p.slug);
var PERMISSION_SLUG_SET = new Set(
  ALL_PERMISSION_SLUGS
);
var WILDCARD_PERMISSION = "*";
function isPermissionSlug(value, options) {
  if (options?.allowWildcard && value === WILDCARD_PERMISSION) return true;
  return PERMISSION_SLUG_SET.has(value);
}
var VALID_PERMISSION_VALUES = [...ALL_PERMISSION_SLUGS, WILDCARD_PERMISSION];
